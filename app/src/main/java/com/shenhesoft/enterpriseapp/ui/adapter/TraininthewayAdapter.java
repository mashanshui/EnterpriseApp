...
public class TraininthewayAdapter extends BaseExpandableListAdapter {

    private List<PDetailsRootItem> data;
    private LayoutInflater mInflater;
    private Context context;

    public TraininthewayAdapter(List<PDetailsRootItem> data, Context context) {
        this.data = data;
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_exlv_pdetails_train, null);
