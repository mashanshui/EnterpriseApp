...
//        setTitle("调度审核");
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        stepSelectCode = getIntent().getStringExtra("stepSelectCode");
        sendCompanyId  = getIntent().getStringExtra("sendCompanyId");
        getgoodsPlace();
    ...
    private void getgoodsPlace() {
        Observable<RequestResultsList<LocationPopBean>> observable = HttpManager.getInstance().getUserService()
                .getNewOrderListGoodsyard(ApiRetrofit.getInstance().getNewOrderListGoodsyard(stepSelectCode, sendCompanyId));
    ...
    private void getgoodssite() {
        Observable<RequestResultsList<LocationPopBean>> observable = HttpManager.getInstance().getUserService()
                .getlistGoodsyardChlid(ApiRetrofit.getInstance().getlistGoodschild(freightId));
