...
public class GuideOrderActivity extends BaseTitleActivity {
    private static final String TAG = "GuideOrderActivity";
...
//        setTitle("调度审核");
    ...
    private void getgoodsPlace() {
        Observable<RequestResultsList<LocationPopBean>> observable = HttpManager.getInstance().getUserService()
                .getArrivalListGoodsyard(ApiRetrofit.getInstance().getArrivalListGoodsyard(orderId));
