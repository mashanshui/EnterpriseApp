...
public class SearchPupItenAdapter<T> extends BaseAdapter implements Filterable {
     ...
     *            populated
     */
    public SearchPupItenAdapter(Context context, int resource, int textViewResourceId) {
     ...
     */
    public SearchPupItenAdapter(Context context, int resource, T[] objects) {
     ...
     *            The objects to represent in the ListView.
     */
    public SearchPupItenAdapter(Context context, int resource, int textViewResourceId, T[] objects) {
     ...
     *            The objects to represent in the ListView.
     */
    public SearchPupItenAdapter(Context context, int resource, int textViewResourceId, List<T> objects) {
     ...
     */
    public static SearchPupItenAdapter<CharSequence> createFromResource(Context context, int textArrayResId,
                                                                        int textViewResId) {
        CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new SearchPupItenAdapter<CharSequence>(context, textViewResId, strings);
    }
