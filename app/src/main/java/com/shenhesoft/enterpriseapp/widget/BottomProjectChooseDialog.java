...
public class BottomProjectChooseDialog extends Dialog implements AdapterView.OnItemClickListener {
    ...
    TextView mTvConfirm;
    private BottomProjectChooseAdapter mAdapter;
    private Context context;
    private onSelectListener listener;
    private int Mposition;

    private List<ProjectBean> mselectlist;
...
//    }
    ...
    public BottomProjectChooseDialog(@NonNull Context context, List<ProjectBean> mlist) {
        super(context, R.style.Dialog);
        this.context = context;
        setContentView(R.layout.dialog_choose);
        KnifeKit.bind(this);
    ...
    private void initView(List<ProjectBean> mlist) {
        mselectlist = mlist;
        mAdapter = new BottomProjectChooseAdapter(context);
