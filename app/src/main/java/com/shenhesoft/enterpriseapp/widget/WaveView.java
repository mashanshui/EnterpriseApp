...
public class WaveView extends View {
    ...
    public static final int DEFAULT_FIRST_WAVE_COLOR = Color.parseColor("#80FFFFFF");
    public static final int DEFAULT_SECOND_WAVE_COLOR = Color.parseColor("#40FFFFFF");
    public static final int DEFAULT_THIRD_WAVE_COLOR = Color.parseColor("#1AFFFFFF");
    ...
    private int mFirstWaveColor = DEFAULT_FIRST_WAVE_COLOR;
    private int mSecondWaveColor = DEFAULT_SECOND_WAVE_COLOR;
    private int mThirdWaveColor = DEFAULT_THIRD_WAVE_COLOR;
    ...
    public void setWaveColor(int firstWaveColor, int secondWaveColor, int thirdWaveColor) {
        mFirstWaveColor = firstWaveColor;
        mSecondWaveColor = secondWaveColor;
        mThirdWaveColor = thirdWaveColor;
    ...
    private void createShader() {
        ...
        wavePaint.setColor(mThirdWaveColor);
        final int wave3Shift = (int) (mDefaultWaveLength / 4);
        for (int beginX = 0; beginX < endX; beginX++) {
